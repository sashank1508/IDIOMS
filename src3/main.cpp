...
int main()
{
    ...
    // 7. Add a new record and then delete it to demonstrate delete functionality
    ...
    // 8. Demonstrate server recovery
    std::cout << "\n8. Demonstrating Server Recovery" << std::endl;
    std::cout << "Checkpointing again before recovery..." << std::endl;
    client.checkpointAllIndices();

    std::cout << "Recovering from checkpoint..." << std::endl;
